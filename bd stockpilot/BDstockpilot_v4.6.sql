...
(1, 'Bodega Principal', 'BOD-01', 'Calle 123 #45-67', 'Bogotá DC', 'Bogotá', 1, 1, NULL, NULL, 1),
(2, 'Centro de Distribución', 'BOD-02', 'Av. Industrial 789', 'Antioquia', 'Medellín', 2, 1, NULL, NULL, 1),
(3, 'Almacén Cali', 'BOD-03', 'Cra. 45 #56-78', 'Valle', 'Cali', 3, 2, NULL, NULL, 1),
(4, 'Depósito Medellín', 'BOD-04', 'Av. Comercial 123', 'Antioquia', 'Medellín', 4, 3, NULL, NULL, 1),
(5, 'Bodega Barranquilla', 'BOD-05', 'Zona Industrial', 'Atlántico', 'Barranquilla', 5, 4, NULL, NULL, 1);
...
(1, 1, 'PROD-001', 'Laptop HP EliteBook', 'Laptop i7 16GB RAM 512GB SSD', 1, 1, 'UND', 5, 50, NULL, 1500000.00, 2500000.00, NULL, NULL, 1),
(1, 2, 'PROD-002', 'Taladro Inalámbrico', 'Taladro 20V con 2 baterías', 2, 1, 'UND', 10, 100, NULL, 250000.00, 450000.00, NULL, NULL, 1),
(1, 3, 'PROD-003', 'Resma Papel A4', 'Paquete 500 hojas 75g', 3, 2, 'UND', 20, 200, NULL, 12000.00, 18000.00, NULL, NULL, 1),
(1, 4, 'PROD-004', 'Silla Oficina', 'Silla ergonómica ejecutiva', 4, 3, 'UND', 5, 30, NULL, 350000.00, 650000.00, NULL, NULL, 1),
(1, 5, 'PROD-005', 'Filtro de Aire', 'Filtro para maquinaria industrial', 5, 4, 'UND', 2, 15, NULL, 85000.00, 150000.00, NULL, NULL, 1),
...
UPDATE producto  SET act = 1 WHERE act IS NULL;
UPDATE ubicacion SET act = 1 WHERE act IS NULL;